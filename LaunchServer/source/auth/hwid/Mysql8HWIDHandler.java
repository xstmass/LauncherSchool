...
public class Mysql8HWIDHandler extends HWIDHandler
{
    ...
    public Mysql8HWIDHandler(BlockConfigEntry block)
    {
        super(block);
        mySQLHolder = new MySQL8SourceConfig("hwidHandlerPool", block);

        // Read query
        query = VerifyHelper.verify(block.getEntryValue("query", StringConfigEntry.class),
                VerifyHelper.NOT_EMPTY, "MySQL8 query can't be empty");
        ...
        querySelect = VerifyHelper.verify(block.getEntryValue("querySelect", StringConfigEntry.class),
                VerifyHelper.NOT_EMPTY, "MySQL8 queryUpd can't be empty");
    ...
    public void writeHWID(HWID hwid, String username, Connection c)
    {
        ...
        try (PreparedStatement a = c.prepareStatement(queryUpd))
        {
            ...
            a.setQueryTimeout(MySQL8SourceConfig.TIMEOUT);
            a.executeUpdate();
        }
        catch (SQLException e)
        {
